...
1. Fork the central repo at [https://github.com/Holograf/Holograf](https://github.com/Holograf/Holograf.git)

1. Clone the forked repo to your local machine

    ```bash
    $ git clone https://github.com/USERNAME/Holograf.git
    ```

1. Configure the remotes by adding the central repository as 'upstream'

    ```bash
    $ git remote add upstream https://github.com/Holograf/Holograf.git
    ```
